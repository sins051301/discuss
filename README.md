...
GitHub에서 벌어진 치열한 PR 토론을 **크롤링하고 한글로 요약/분석**하는 Docusaurus 사이트입니다.

## 어떤 프로젝트인가요?

1. PR 링크를 주면 → 크롤링 스크립트가 모든 토론 데이터를 수집합니다
2. AI가 토론을 한글로 요약/분석합니다 (배경, 쟁점, 결론, 배울 점)
3. Docusaurus 사이트에서 깔끔하게 열람합니다

원문은 PR 링크에서 직접 읽을 수 있으므로, 별도 번역 없이 **분석에 집중**합니다.
...
AI가 `raw.json`을 읽고 `analysis.md`를 생성합니다:

| 항목 | 내용 |
|------|------|
| 한줄 요약 | PR이 무엇인지 한 문장 |
| 배경 | 비전공자도 이해할 수 있는 쉬운 설명 |
| 주요 쟁점 | 토론에서 논의된 핵심 포인트 |
| 결론 | 어떻게 마무리되었는지 |
| 배울 점 | 오픈소스 협업 관점의 교훈 |
